...
public class SewingTemplateItem extends Item {
    ...
    private static final Component GLIDER_DESIGN_APPLIES_TO;
    private static final Component GLIDER_DESIGN_INGREDIENTS;
    private static final Component GLIDER_DESIGN_BASE_SLOT_DESCRIPTION;
    private static final Component GLIDER_DESIGN_ADDITIONS_SLOT_DESCRIPTION;
    ...
    public void appendHoverText(@NotNull ItemStack stack, Item.@NotNull TooltipContext context, @NotNull List<Component> tooltipComponents, @NotNull TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(CommonComponents.space().append(GLIDER_DESIGN_APPLIES_TO));
        tooltipComponents.add(INGREDIENTS_TITLE);
        tooltipComponents.add(CommonComponents.space().append(GLIDER_DESIGN_INGREDIENTS));
    }

    public Component getBaseSlotDescription() {
        return GLIDER_DESIGN_BASE_SLOT_DESCRIPTION;
    }

    public Component getAdditionSlotDescription() {
        return GLIDER_DESIGN_ADDITIONS_SLOT_DESCRIPTION;
    }
    ...
    static {
        ...
        GLIDER_DESIGN_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", SkysSkyIslands.createId("sewing_template.glider_design.applies_to"))).withStyle(DESCRIPTION_FORMAT);
        GLIDER_DESIGN_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", SkysSkyIslands.createId("sewing_template.glider_design.ingredients"))).withStyle(DESCRIPTION_FORMAT);
        GLIDER_DESIGN_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", SkysSkyIslands.createId("sewing_template.glider_design.base_slot_description")));
        GLIDER_DESIGN_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", SkysSkyIslands.createId("sewing_template.glider_design.additions_slot_description")));
