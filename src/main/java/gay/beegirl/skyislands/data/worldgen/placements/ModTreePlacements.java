...
public class ModTreePlacements {
	...
	public static final ResourceKey<PlacedFeature> FRIGID_PINE =			ModPlacementUtils.createKey("frigid_pine");
	public static final ResourceKey<PlacedFeature> FRIGID_SPRUCE =			ModPlacementUtils.createKey("frigid_spruce");
	public static final ResourceKey<PlacedFeature> FRIGID_PINE_BEES_005 =	ModPlacementUtils.createKey("frigid_pine_bees_005");
	public static final ResourceKey<PlacedFeature> FRIGID_SPRUCE_BEES_005 =	ModPlacementUtils.createKey("frigid_spruce_bees_005");
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(context, FRIGID_PINE, configuredFeatures.getOrThrow(ModTreeFeatures.FRIGID_PINE), List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.FRIGID_SAPLING.get())));
		PlacementUtils.register(context, FRIGID_SPRUCE, configuredFeatures.getOrThrow(ModTreeFeatures.FRIGID_SPRUCE), List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.FRIGID_SAPLING.get())));
		PlacementUtils.register(context, FRIGID_PINE_BEES_005, configuredFeatures.getOrThrow(ModTreeFeatures.FRIGID_PINE_BEES_005), List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.FRIGID_SAPLING.get())));
		PlacementUtils.register(context, FRIGID_SPRUCE_BEES_005, configuredFeatures.getOrThrow(ModTreeFeatures.FRIGID_SPRUCE_BEES_005), List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.FRIGID_SAPLING.get())));
