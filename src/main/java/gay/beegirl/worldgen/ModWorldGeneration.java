...
public class ModWorldGeneration {
    public static void registerWorldGeneration() {
        ...
        BiomeModifications.addFeature(BiomeSelectors.tag(ModTags.Biomes.SKY_ISLANDS), GenerationStep.Decoration.UNDERGROUND_ORES, ModPlacedFeatures.SKY_ALEXANDRITE_ORE);
    }
}
